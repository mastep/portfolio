...
<head>
    <meta charset="UTF-8" />
    <title>Новогодний розыгрыш призов</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .preloader {
            ...
            display: none; /*todo убрать при старте*/
        }
        ...
        .lottery__grid-wrapper {
            ...
            padding: 1.2rem;
            overflow: hidden;
            overflow-y: auto; /*todo убрать при старте*/
        }
...
<div class="preloader" id="preloader">
    <div class="preloader__content">
        <div class="preloader__icon"><img src="lib/images/icon-projector.png" width="100%"></div>
    ...
    <div class="intro__content">
        ...
        <div class="intro__meta">
            <div class="intro__meta-item">
                <strong>Супер простые правила</strong>
                <span>1. Подписаться на <a href="https://t.me/svnlab">наш канал</a> <br>2. Разместить пост с хештегом <strong>#ЯвДеле7LABPRO</strong> в любой соц.сети;<br>3. Прислать ссылку на пост и свое фото <a href="https://t.me/pro_7lab_bot">нашему чат боту</a></span>
            </div>
        </div>
    ...
    <div class="lottery__grid-wrapper">
        ...
        <div class="lottery__pre-timer" id="preTimer">
            <div class="lottery__pre-timer-inner">
                ...
                <div class="lottery__pre-timer-label">Розыгрыш IT решения под ключ</div>
            </div>
        </div>
...
<script>
    ...
    function createEmployeeElement(index) {
        ...
        img.src = EMPLOYEE_AVATAR_DATA_URIS[index];
    ...
    function runLottery() {
        ...
        return; //todo убрать перед запуском
        updateCountAttribute();
