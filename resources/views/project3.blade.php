        ...
        <section>
            <div class="stg-row stg-bottom-gap-l stg-tp-bottom-gap">
                ...
                <div class="stg-col-6 stg-tp-col-9 stg-tp-offset-3 align-right" data-appear="fade-up" data-delay="100" data-unload="fade-right">
                    <p>Здесь мы расскажем как создавали свою резиденцию в сети Интернет. Почему наш проект является более сложной версией, чем просто сайта визитки.  Покажем кто скрывается в нашем логотипе. Как происходит фоновая загрузка контента, чем она отличается от стандартной. Как выбирали название и домен. Почему не боимся взлома сайта. Как просходит обновление контента и многое другое.</p>
                </div>
            </div>
        ...
        <section>
            ...
            <div class="stg-row" data-appear="fade-up" data-delay="100" data-unload="fade-right">
                <div class="stg-col-9 stg-offset-3 stg-tp-col-10 stg-tp-offset-2">
                    ...
                    <p class="bringer-large-text">Чтобы посмотреть кто именно скрывается в лого нажмите <a onClick="$('#bringer-header').toggleClass('light_color')">здесь</a> и посмотрите на логотип.</p>
