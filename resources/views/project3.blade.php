        ...
        <section>
            ...
            <div class="stg-row" data-appear="fade-up" data-delay="100" data-unload="fade-right">
                <div class="stg-col-9 stg-offset-3 stg-tp-col-10 stg-tp-offset-2">
                    ...
                    <p class="bringer-large-text">Чтобы посмотреть кто именно скрывается в лого нажмите <a href="#" onClick="$('#bringer-header').toggleClass('light_color')">здесь</a> (если вы открыли сайт через телефон, переверните его) и посмотрите на логотип.</p>
                    <p class="bringer-large-text">Мы обязательно будем дополнять информацию о нашем проекте как только реализуем какую-нибудь интересную фичу. Следите за обновлениями.<br>А пока можете заказать себе <a href="/landing-page">сайт-визитку</a>.<br><br>Спасибо и до встречи!</p>
                </div>
            </div>
