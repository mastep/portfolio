            ...
            <section>
                <div class="stg-row stg-bottom-gap-l stg-tp-bottom-gap">
                    <div class="stg-col-6 stg-tp-bottom-gap">
                        <h1 class="bringer-post-title" data-appear="fade-up" data-unload="fade-left"><b style="padding:10px 15px; border: 2px solid #3f6ee9">Д</b>етекция изображения / YOLOE</h1>
                    </div>
            ...
            <section class="backlight-both" id="page01">
                ...
                <div class="stg-row stg-bottom-gap stg-valign-middle stg-tp-row-reverse stg-m-bottom-gap-l" data-unload="fade-right">
                    ...
                    <div class="stg-col-6 stg-tp-col-6" data-appear="fade-left" data-delay="100">
                        ...
                        <h4>Видеонаблюдение с ИИ</h4>
                        <p>Проведём интеграцию ИИ-системы с вашей существующей видеосетью. В процессе мы настроим алгоритмы детекции и распознавания на локальном сервере. Система будет обучаться на ваших эталонных данных, обеспечивая точное и быстрое сопоставление лиц. Это позволит автоматизировать контроль доступа, не изменяя вашу текущую инфраструктуру.</p>
                    </div>
