...
<style>
    ...
    .video-wrapper::after {
        ...
        @php
            $titles = [
                // Блок УТП и ИИ-решений (На основе ИИ-агентов и Mini Apps)
  'Интегрируем ИИ в бизнес и создаем e-com',
  '120+ ИИ-агентов уже работают в наших проектах без найма в штат',
  'Создаем AI-ботов и Mini Apps с поддержкой 24/7',
  'Поручите рутинные бизнес-задачи ИИ-агентам для оптимизации расходов',

  // Блок MVP и Веб-разработки
  'IT-решения для бизнеса: создаем MVP за 5 дней',
  'Запускаем современные интернет-магазины под ключ',
  'Закрываем абсолютно все технические вопросы от эквайринга до серверов',
  ...
  // Стек, Экспертиза и Акции
  'Разработчики со специализацией на e-commerce и ИИ-агентах',
  'Строим системы, которые работают за вас: продают и обслуживают',
  'Приминяем технологии: Docker, Kafka, PHP, Laravel'
            ];
        @endphp
