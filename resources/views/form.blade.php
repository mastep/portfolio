...
<main id="bringer-main">
    <div class="stg-container">
        <section style="background: #FFFFFF; padding: 30px; border-radius:30px">
            ...
            <p style="color:#d3b574">заполните форму или просто <a href='https://t.me/burtonTeam'>отправьте голосовое <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 240.1 240.1">
