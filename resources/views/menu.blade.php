...
<div class="bringer-header-mp">
    <nav class="bringer-nav">
        <ul class="main-menu" data-stagger-appear="fade-down" data-stagger-delay="75" itemscope itemtype="https://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope
                ...
                <ul class="sub-menu">
                    <li>
                        <a itemprop="item" class="phb_link"></a>
                    </li>
                    <li>
                        <a itemprop="item" class="pmb_link"></a>
                    </li>
                    <li>
