        ...
        <section class="backlight-both">
            ...
            <div class="stg-row stg-bottom-gap stg-valign-middle stg-m-bottom-gap-l" data-unload="fade-left">
                ...
                <div class="stg-col-6 stg-tp-col-6" data-appear="fade-right" data-delay="100">
                    ...
                    <h4>Прием платежей / Витрина / Mini App</h4>
                    <p>Бот может выступать в роли витрины магазина или платежного терминала. Благодаря интеграции с популярными платежными системами (например, Stripe, ЮKassa), пользователи могут просматривать товары или услуги и оплачивать их прямо в интерфейсе мессенджера при помощи <a href="/webapp/">Mini Apps приложений</a>.</p>
                </div>
            </div>
            <!-- Details 04 Row -->
            <div class="stg-row stg-bottom-gap stg-valign-middle stg-tp-row-reverse stg-m-bottom-gap-l" data-unload="fade-right">
