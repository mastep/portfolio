        ...
        <section data-padding="top" class="backlight-top">
            <div class="stg-row stg-bottom-gap-l">
                ...
                <div class="stg-col-6 stg-tp-col-10 stg-tp-offset-2" data-appear="fade-left" data-unload="fade-right">
                    <p class="bringer-large-text">Корпоративный портал является ключевым элементом внутренней коммуникации в компании, и новости играют в нём важную роль. Они не только информируют сотрудников о последних событиях и достижениях. Поэтому информационный блок занял центральную часть проекта, а превью фото создает настроение главной страницы при каждом добавлении новой новости.</p>
